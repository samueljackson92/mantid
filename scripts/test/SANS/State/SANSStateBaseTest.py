...
from SANS2.State.SANSStateBase import (StringParameter, BoolParameter, FloatParameter, PositiveFloatParameter,
...
# ----------------------------------------------------------------------------------------------------------------------
@sans_parameters
class SANStateBaseTestClass(SANSStateBase):
    ...
    def __init__(self):
        super(SANStateBaseTestClass, self).__init__()
...
class TypedParameterTest(unittest.TestCase):
    ...
    def test_that_can_set_to_valid_value_of_correct_type(self):
        test_class = SANStateBaseTestClass()
        try:
...
@sans_parameters
class SimpleState(SANSStateBase):
    string_parameter = StringParameter()
    bool_parameter = BoolParameter()
    float_parameter = FloatParameter()
    positive_float_parameter = PositiveFloatParameter()
...
@sans_parameters
class ComplexState(SANSStateBase):
    float_parameter = FloatParameter()
    positive_float_with_none_parameter = PositiveFloatWithNoneParameter()
...
class TestSANSStateBase(unittest.TestCase):
